...
|---|---|---|---|---|---|
|<span id="list-item-errcheck" title=""></span>[errcheck&nbsp;<FaCog size={'0.8rem'} />](#errcheck "errcheck configuration")&nbsp;[<span title="errcheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/kisielk/errcheck)|Errcheck is a program for checking for unchecked errors in Go code. These unchecked errors can be critical bugs in some cases.|bugs, error||v1.0.0|
|<span id="list-item-gosimple" title=""></span>[gosimple&nbsp;<FaCog size={'0.8rem'} />](#gosimple "gosimple configuration")&nbsp;[<span title="gosimple repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/dominikh/go-tools/tree/HEAD/simple)|Linter for Go source code that specializes in simplifying code.|style|<span title="Auto fix supported">✔</span>|v1.20.0|
|<span id="list-item-govet" title=""></span>[govet&nbsp;<FaCog size={'0.8rem'} />](#govet "govet configuration")&nbsp;[<span title="govet repository"><FaGithub size={'0.8rem'} /></span>](https://pkg.go.dev/cmd/vet)|Vet examines Go source code and reports suspicious constructs. It is roughly the same as 'go vet' and uses its passes.|bugs, metalinter|<span title="Auto fix supported">✔</span>|v1.0.0|
|<span id="list-item-ineffassign" title=""></span><span id="ineffassign" title=""></span>[ineffassign](#ineffassign "ineffassign has no configuration")&nbsp;[<span title="ineffassign repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/gordonklaus/ineffassign)|Detects when assignments to existing variables are not used.|unused||v1.0.0|
|<span id="list-item-staticcheck" title=""></span>[staticcheck&nbsp;<FaCog size={'0.8rem'} />](#staticcheck "staticcheck configuration")&nbsp;[<span title="staticcheck repository"><FaGithub size={'0.8rem'} /></span>](https://staticcheck.dev/)|It's a set of rules from staticcheck. It's not the same thing as the staticcheck binary. The author of staticcheck doesn't support or approve the use of staticcheck as a library inside golangci-lint.|bugs, metalinter|<span title="Auto fix supported">✔</span>|v1.0.0|
|<span id="list-item-unused" title=""></span>[unused&nbsp;<FaCog size={'0.8rem'} />](#unused "unused configuration")&nbsp;[<span title="unused repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/dominikh/go-tools/tree/HEAD/unused)|Checks Go code for unused constants, variables, functions and types.|unused||v1.20.0|

## Disabled by Default

|Name|Description|Presets|AutoFix|Since|
|---|---|---|---|---|---|
|<span id="list-item-asasalint" title=""></span>[asasalint&nbsp;<FaCog size={'0.8rem'} />](#asasalint "asasalint configuration")&nbsp;[<span title="asasalint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/alingse/asasalint)|Check for pass []any as any in variadic func(...any).|bugs||v1.47.0|
|<span id="list-item-asciicheck" title=""></span><span id="asciicheck" title=""></span>[asciicheck](#asciicheck "asciicheck has no configuration")&nbsp;[<span title="asciicheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/tdakkota/asciicheck)|Checks that all code identifiers does not have non-ASCII symbols in the name.|bugs, style||v1.26.0|
|<span id="list-item-bidichk" title=""></span>[bidichk&nbsp;<FaCog size={'0.8rem'} />](#bidichk "bidichk configuration")&nbsp;[<span title="bidichk repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/breml/bidichk)|Checks for dangerous unicode character sequences.|bugs||v1.43.0|
|<span id="list-item-bodyclose" title=""></span><span id="bodyclose" title=""></span>[bodyclose](#bodyclose "bodyclose has no configuration")&nbsp;[<span title="bodyclose repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/timakin/bodyclose)|Checks whether HTTP response body is closed successfully.|performance, bugs||v1.18.0|
|<span id="list-item-canonicalheader" title=""></span><span id="canonicalheader" title=""></span>[canonicalheader](#canonicalheader "canonicalheader has no configuration")&nbsp;[<span title="canonicalheader repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/lasiar/canonicalheader)|Canonicalheader checks whether net/http.Header uses canonical header.|style|<span title="Auto fix supported">✔</span>|v1.58.0|
|<span id="list-item-containedctx" title=""></span><span id="containedctx" title=""></span>[containedctx](#containedctx "containedctx has no configuration")&nbsp;[<span title="containedctx repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/sivchari/containedctx)|Containedctx is a linter that detects struct contained context.Context field.|style||v1.44.0|
|<span id="list-item-contextcheck" title=""></span><span id="contextcheck" title=""></span>[contextcheck](#contextcheck "contextcheck has no configuration")&nbsp;[<span title="contextcheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/kkHAIKE/contextcheck)|Check whether the function uses a non-inherited context.|bugs||v1.43.0|
|<span id="list-item-copyloopvar" title=""></span>[copyloopvar&nbsp;<FaCog size={'0.8rem'} />](#copyloopvar "copyloopvar configuration")&nbsp;[<span title="copyloopvar repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/karamaru-alpha/copyloopvar)|A linter detects places where loop variables are copied.|style|<span title="Auto fix supported">✔</span>|v1.57.0|
|<span id="list-item-cyclop" title=""></span>[cyclop&nbsp;<FaCog size={'0.8rem'} />](#cyclop "cyclop configuration")&nbsp;[<span title="cyclop repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/bkielbasa/cyclop)|Checks function and package cyclomatic complexity.|complexity||v1.37.0|
|<span id="list-item-decorder" title=""></span>[decorder&nbsp;<FaCog size={'0.8rem'} />](#decorder "decorder configuration")&nbsp;[<span title="decorder repository"><FaGitlab size={'0.8rem'} /></span>](https://gitlab.com/bosi/decorder)|Check declaration order and count of types, constants, variables and functions.|style||v1.44.0|
|<span id="list-item-depguard" title=""></span>[depguard&nbsp;<FaCog size={'0.8rem'} />](#depguard "depguard configuration")&nbsp;[<span title="depguard repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/OpenPeeDeeP/depguard)|Go linter that checks if package imports are in a list of acceptable packages.|style, import, module||v1.4.0|
|<span id="list-item-dogsled" title=""></span>[dogsled&nbsp;<FaCog size={'0.8rem'} />](#dogsled "dogsled configuration")&nbsp;[<span title="dogsled repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/alexkohler/dogsled)|Checks assignments with too many blank identifiers (e.g. x, _, _, _, := f()).|style||v1.19.0|
|<span id="list-item-dupl" title=""></span>[dupl&nbsp;<FaCog size={'0.8rem'} />](#dupl "dupl configuration")&nbsp;[<span title="dupl repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/mibk/dupl)|Detects duplicate fragments of code.|style||v1.0.0|
|<span id="list-item-dupword" title=""></span>[dupword&nbsp;<FaCog size={'0.8rem'} />](#dupword "dupword configuration")&nbsp;[<span title="dupword repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/Abirdcfly/dupword)|Checks for duplicate words in the source code.|comment|<span title="Auto fix supported">✔</span>|v1.50.0|
|<span id="list-item-durationcheck" title=""></span><span id="durationcheck" title=""></span>[durationcheck](#durationcheck "durationcheck has no configuration")&nbsp;[<span title="durationcheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/charithe/durationcheck)|Check for two durations multiplied together.|bugs||v1.37.0|
|<span id="list-item-err113" title=""></span><span id="err113" title=""></span>[err113](#err113 "err113 has no configuration")&nbsp;[<span title="err113 repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/Djarvur/go-err113)|Go linter to check the errors handling expressions.|style, error|<span title="Auto fix supported">✔</span>|v1.26.0|
|<span id="list-item-errchkjson" title=""></span>[errchkjson&nbsp;<FaCog size={'0.8rem'} />](#errchkjson "errchkjson configuration")&nbsp;[<span title="errchkjson repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/breml/errchkjson)|Checks types passed to the json encoding functions. Reports unsupported types and reports occurrences where the check for the returned error can be omitted.|bugs||v1.44.0|
|<span id="list-item-errname" title=""></span><span id="errname" title=""></span>[errname](#errname "errname has no configuration")&nbsp;[<span title="errname repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/Antonboom/errname)|Checks that sentinel errors are prefixed with the `Err` and error types are suffixed with the `Error`.|style||v1.42.0|
|<span id="list-item-errorlint" title=""></span>[errorlint&nbsp;<FaCog size={'0.8rem'} />](#errorlint "errorlint configuration")&nbsp;[<span title="errorlint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/polyfloyd/go-errorlint)|Errorlint is a linter for that can be used to find code that will cause problems with the error wrapping scheme introduced in Go 1.13.|bugs, error|<span title="Auto fix supported">✔</span>|v1.32.0|
|<span id="list-item-exhaustive" title=""></span>[exhaustive&nbsp;<FaCog size={'0.8rem'} />](#exhaustive "exhaustive configuration")&nbsp;[<span title="exhaustive repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/nishanths/exhaustive)|Check exhaustiveness of enum switch statements.|bugs|| v1.28.0|
|<span id="list-item-exhaustruct" title=""></span>[exhaustruct&nbsp;<FaCog size={'0.8rem'} />](#exhaustruct "exhaustruct configuration")&nbsp;[<span title="exhaustruct repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/GaijinEntertainment/go-exhaustruct)|Checks if all structure fields are initialized.|style, test||v1.46.0|
|<span id="list-item-exptostd" title=""></span><span id="exptostd" title=""></span>[exptostd](#exptostd "exptostd has no configuration")&nbsp;[<span title="exptostd repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ldez/exptostd)|Detects functions from golang.org/x/exp/ that can be replaced by std functions.|style|<span title="Auto fix supported">✔</span>|v1.63.0|
|<span id="list-item-fatcontext" title=""></span>[fatcontext&nbsp;<FaCog size={'0.8rem'} />](#fatcontext "fatcontext configuration")&nbsp;[<span title="fatcontext repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/Crocmagnon/fatcontext)|Detects nested contexts in loops and function literals.|performance|<span title="Auto fix supported">✔</span>|v1.58.0|
|<span id="list-item-forbidigo" title=""></span>[forbidigo&nbsp;<FaCog size={'0.8rem'} />](#forbidigo "forbidigo configuration")&nbsp;[<span title="forbidigo repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ashanbrown/forbidigo)|Forbids identifiers.|style||v1.34.0|
|<span id="list-item-forcetypeassert" title=""></span><span id="forcetypeassert" title=""></span>[forcetypeassert](#forcetypeassert "forcetypeassert has no configuration")&nbsp;[<span title="forcetypeassert repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/gostaticanalysis/forcetypeassert)|Finds forced type assertions.|style||v1.38.0|
|<span id="list-item-funlen" title=""></span>[funlen&nbsp;<FaCog size={'0.8rem'} />](#funlen "funlen configuration")&nbsp;[<span title="funlen repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ultraware/funlen)|Checks for long functions.|complexity||v1.18.0|
|<span id="list-item-gci" title=""></span>[gci&nbsp;<FaCog size={'0.8rem'} />](#gci "gci configuration")&nbsp;[<span title="gci repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/daixiang0/gci)|Checks if code and import statements are formatted, with additional rules.|format, import|<span title="Auto fix supported">✔</span>|v1.30.0|
|<span id="list-item-ginkgolinter" title=""></span>[ginkgolinter&nbsp;<FaCog size={'0.8rem'} />](#ginkgolinter "ginkgolinter configuration")&nbsp;[<span title="ginkgolinter repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/nunnatsa/ginkgolinter)|Enforces standards of using ginkgo and gomega.|style|<span title="Auto fix supported">✔</span>|v1.51.0|
|<span id="list-item-gocheckcompilerdirectives" title=""></span><span id="gocheckcompilerdirectives" title=""></span>[gocheckcompilerdirectives](#gocheckcompilerdirectives "gocheckcompilerdirectives has no configuration")&nbsp;[<span title="gocheckcompilerdirectives repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/leighmcculloch/gocheckcompilerdirectives)|Checks that go compiler directive comments (//go:) are valid.|bugs||v1.51.0|
|<span id="list-item-gochecknoglobals" title=""></span><span id="gochecknoglobals" title=""></span>[gochecknoglobals](#gochecknoglobals "gochecknoglobals has no configuration")&nbsp;[<span title="gochecknoglobals repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/leighmcculloch/gochecknoglobals)|Check that no global variables exist.|style||v1.12.0|
|<span id="list-item-gochecknoinits" title=""></span><span id="gochecknoinits" title=""></span>[gochecknoinits](#gochecknoinits "gochecknoinits has no configuration")|Checks that no init functions are present in Go code.|style||v1.12.0|
|<span id="list-item-gochecksumtype" title=""></span>[gochecksumtype&nbsp;<FaCog size={'0.8rem'} />](#gochecksumtype "gochecksumtype configuration")&nbsp;[<span title="gochecksumtype repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/alecthomas/go-check-sumtype)|Run exhaustiveness checks on Go "sum types".|bugs||v1.55.0|
|<span id="list-item-gocognit" title=""></span>[gocognit&nbsp;<FaCog size={'0.8rem'} />](#gocognit "gocognit configuration")&nbsp;[<span title="gocognit repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/uudashr/gocognit)|Computes and checks the cognitive complexity of functions.|complexity||v1.20.0|
|<span id="list-item-goconst" title=""></span>[goconst&nbsp;<FaCog size={'0.8rem'} />](#goconst "goconst configuration")&nbsp;[<span title="goconst repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/jgautheron/goconst)|Finds repeated strings that could be replaced by a constant.|style||v1.0.0|
|<span id="list-item-gocritic" title=""></span>[gocritic&nbsp;<FaCog size={'0.8rem'} />](#gocritic "gocritic configuration")&nbsp;[<span title="gocritic repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/go-critic/go-critic)|Provides diagnostics that check for bugs, performance and style issues.<br/>Extensible without recompilation through dynamic rules.<br/>Dynamic rules are written declaratively with AST patterns, filters, report message and optional suggestion.|style, metalinter|<span title="Auto fix supported">✔</span>|v1.12.0|
|<span id="list-item-gocyclo" title=""></span>[gocyclo&nbsp;<FaCog size={'0.8rem'} />](#gocyclo "gocyclo configuration")&nbsp;[<span title="gocyclo repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/fzipp/gocyclo)|Computes and checks the cyclomatic complexity of functions.|complexity||v1.0.0|
|<span id="list-item-godot" title=""></span>[godot&nbsp;<FaCog size={'0.8rem'} />](#godot "godot configuration")&nbsp;[<span title="godot repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/tetafro/godot)|Check if comments end in a period.|style, comment|<span title="Auto fix supported">✔</span>|v1.25.0|
|<span id="list-item-godox" title=""></span>[godox&nbsp;<FaCog size={'0.8rem'} />](#godox "godox configuration")&nbsp;[<span title="godox repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/matoous/godox)|Detects usage of FIXME, TODO and other keywords inside comments.|style, comment||v1.19.0|
|<span id="list-item-gofmt" title=""></span>[gofmt&nbsp;<FaCog size={'0.8rem'} />](#gofmt "gofmt configuration")&nbsp;[<span title="gofmt repository"><FaGithub size={'0.8rem'} /></span>](https://pkg.go.dev/cmd/gofmt)|Checks if the code is formatted according to 'gofmt' command.|format|<span title="Auto fix supported">✔</span>|v1.0.0|
|<span id="list-item-gofumpt" title=""></span>[gofumpt&nbsp;<FaCog size={'0.8rem'} />](#gofumpt "gofumpt configuration")&nbsp;[<span title="gofumpt repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/mvdan/gofumpt)|Checks if code and import statements are formatted, with additional rules.|format|<span title="Auto fix supported">✔</span>|v1.28.0|
|<span id="list-item-goheader" title=""></span>[goheader&nbsp;<FaCog size={'0.8rem'} />](#goheader "goheader configuration")&nbsp;[<span title="goheader repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/denis-tingaikin/go-header)|Checks if file header matches to pattern.|style|<span title="Auto fix supported">✔</span>|v1.28.0|
|<span id="list-item-goimports" title=""></span>[goimports&nbsp;<FaCog size={'0.8rem'} />](#goimports "goimports configuration")&nbsp;[<span title="goimports repository"><FaGithub size={'0.8rem'} /></span>](https://pkg.go.dev/golang.org/x/tools/cmd/goimports)|Checks if the code and import statements are formatted according to the 'goimports' command.|format, import|<span title="Auto fix supported">✔</span>|v1.20.0|
|<span id="list-item-gomoddirectives" title=""></span>[gomoddirectives&nbsp;<FaCog size={'0.8rem'} />](#gomoddirectives "gomoddirectives configuration")&nbsp;[<span title="gomoddirectives repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ldez/gomoddirectives)|Manage the use of 'replace', 'retract', and 'excludes' directives in go.mod.|style, module||v1.39.0|
|<span id="list-item-gomodguard" title=""></span>[gomodguard&nbsp;<FaCog size={'0.8rem'} />](#gomodguard "gomodguard configuration")&nbsp;[<span title="gomodguard repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ryancurrah/gomodguard)|Allow and block list linter for direct Go module dependencies. This is different from depguard where there are different block types for example version constraints and module recommendations.|style, import, module||v1.25.0|
|<span id="list-item-goprintffuncname" title=""></span><span id="goprintffuncname" title=""></span>[goprintffuncname](#goprintffuncname "goprintffuncname has no configuration")&nbsp;[<span title="goprintffuncname repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/golangci/go-printf-func-name)|Checks that printf-like functions are named with `f` at the end.|style||v1.23.0|
|<span id="list-item-gosec" title=""></span>[gosec&nbsp;<FaCog size={'0.8rem'} />](#gosec "gosec configuration")&nbsp;[<span title="gosec repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/securego/gosec)|Inspects source code for security problems.|bugs||v1.0.0|
|<span id="list-item-gosmopolitan" title=""></span>[gosmopolitan&nbsp;<FaCog size={'0.8rem'} />](#gosmopolitan "gosmopolitan configuration")&nbsp;[<span title="gosmopolitan repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/xen0n/gosmopolitan)|Report certain i18n/l10n anti-patterns in your Go codebase.|bugs||v1.53.0|
|<span id="list-item-grouper" title=""></span>[grouper&nbsp;<FaCog size={'0.8rem'} />](#grouper "grouper configuration")&nbsp;[<span title="grouper repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/leonklingele/grouper)|Analyze expression groups.|style||v1.44.0|
|<span id="list-item-iface" title=""></span>[iface&nbsp;<FaCog size={'0.8rem'} />](#iface "iface configuration")&nbsp;[<span title="iface repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/uudashr/iface)|Detect the incorrect use of interfaces, helping developers avoid interface pollution.|style|<span title="Auto fix supported">✔</span>|v1.62.0|
|<span id="list-item-importas" title=""></span>[importas&nbsp;<FaCog size={'0.8rem'} />](#importas "importas configuration")&nbsp;[<span title="importas repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/julz/importas)|Enforces consistent import aliases.|style|<span title="Auto fix supported">✔</span>|v1.38.0|
|<span id="list-item-inamedparam" title=""></span>[inamedparam&nbsp;<FaCog size={'0.8rem'} />](#inamedparam "inamedparam configuration")&nbsp;[<span title="inamedparam repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/macabu/inamedparam)|Reports interfaces with unnamed method parameters.|style||v1.55.0|
|<span id="list-item-interfacebloat" title=""></span>[interfacebloat&nbsp;<FaCog size={'0.8rem'} />](#interfacebloat "interfacebloat configuration")&nbsp;[<span title="interfacebloat repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/sashamelentyev/interfacebloat)|A linter that checks the number of methods inside an interface.|style||v1.49.0|
|<span id="list-item-intrange" title=""></span><span id="intrange" title=""></span>[intrange](#intrange "intrange has no configuration")&nbsp;[<span title="intrange repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ckaznocha/intrange)|Intrange is a linter to find places where for loops could make use of an integer range.|style|<span title="Auto fix supported">✔</span>|v1.57.0|
|<span id="list-item-ireturn" title=""></span>[ireturn&nbsp;<FaCog size={'0.8rem'} />](#ireturn "ireturn configuration")&nbsp;[<span title="ireturn repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/butuzov/ireturn)|Accept Interfaces, Return Concrete Types.|style||v1.43.0|
|<span id="list-item-lll" title=""></span>[lll&nbsp;<FaCog size={'0.8rem'} />](#lll "lll configuration")|Reports long lines.|style||v1.8.0|
|<span id="list-item-loggercheck" title=""></span>[loggercheck&nbsp;<FaCog size={'0.8rem'} />](#loggercheck "loggercheck configuration")&nbsp;[<span title="loggercheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/timonwong/loggercheck)|Checks key value pairs for common logger libraries (kitlog,klog,logr,zap).|style, bugs||v1.49.0|
|<span id="list-item-maintidx" title=""></span>[maintidx&nbsp;<FaCog size={'0.8rem'} />](#maintidx "maintidx configuration")&nbsp;[<span title="maintidx repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/yagipy/maintidx)|Maintidx measures the maintainability index of each function.|complexity||v1.44.0|
|<span id="list-item-makezero" title=""></span>[makezero&nbsp;<FaCog size={'0.8rem'} />](#makezero "makezero configuration")&nbsp;[<span title="makezero repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ashanbrown/makezero)|Finds slice declarations with non-zero initial length.|style, bugs||v1.34.0|
|<span id="list-item-mirror" title=""></span><span id="mirror" title=""></span>[mirror](#mirror "mirror has no configuration")&nbsp;[<span title="mirror repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/butuzov/mirror)|Reports wrong mirror patterns of bytes/strings usage.|style|<span title="Auto fix supported">✔</span>|v1.53.0|
|<span id="list-item-misspell" title=""></span>[misspell&nbsp;<FaCog size={'0.8rem'} />](#misspell "misspell configuration")&nbsp;[<span title="misspell repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/client9/misspell)|Finds commonly misspelled English words.|style, comment|<span title="Auto fix supported">✔</span>|v1.8.0|
|<span id="list-item-mnd" title=""></span>[mnd&nbsp;<FaCog size={'0.8rem'} />](#mnd "mnd configuration")&nbsp;[<span title="mnd repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/tommy-muehle/go-mnd)|An analyzer to detect magic numbers.|style||v1.22.0|
|<span id="list-item-musttag" title=""></span>[musttag&nbsp;<FaCog size={'0.8rem'} />](#musttag "musttag configuration")&nbsp;[<span title="musttag repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/go-simpler/musttag)|Enforce field tags in (un)marshaled structs.|style, bugs||v1.51.0|
|<span id="list-item-nakedret" title=""></span>[nakedret&nbsp;<FaCog size={'0.8rem'} />](#nakedret "nakedret configuration")&nbsp;[<span title="nakedret repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/alexkohler/nakedret)|Checks that functions with naked returns are not longer than a maximum size (can be zero).|style|<span title="Auto fix supported">✔</span>|v1.19.0|
|<span id="list-item-nestif" title=""></span>[nestif&nbsp;<FaCog size={'0.8rem'} />](#nestif "nestif configuration")&nbsp;[<span title="nestif repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/nakabonne/nestif)|Reports deeply nested if statements.|complexity||v1.25.0|
|<span id="list-item-nilerr" title=""></span><span id="nilerr" title=""></span>[nilerr](#nilerr "nilerr has no configuration")&nbsp;[<span title="nilerr repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/gostaticanalysis/nilerr)|Finds the code that returns nil even if it checks that the error is not nil.|bugs||v1.38.0|
|<span id="list-item-nilnesserr" title=""></span><span id="nilnesserr" title=""></span>[nilnesserr](#nilnesserr "nilnesserr has no configuration")&nbsp;[<span title="nilnesserr repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/alingse/nilnesserr)|Reports constructs that checks for err != nil, but returns a different nil value error.<br/>Powered by nilness and nilerr.|bugs||v1.63.0|
|<span id="list-item-nilnil" title=""></span>[nilnil&nbsp;<FaCog size={'0.8rem'} />](#nilnil "nilnil configuration")&nbsp;[<span title="nilnil repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/Antonboom/nilnil)|Checks that there is no simultaneous return of `nil` error and an invalid value.|style||v1.43.0|
|<span id="list-item-nlreturn" title=""></span>[nlreturn&nbsp;<FaCog size={'0.8rem'} />](#nlreturn "nlreturn configuration")&nbsp;[<span title="nlreturn repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ssgreg/nlreturn)|Nlreturn checks for a new line before return and branch statements to increase code clarity.|style|<span title="Auto fix supported">✔</span>|v1.30.0|
|<span id="list-item-noctx" title=""></span><span id="noctx" title=""></span>[noctx](#noctx "noctx has no configuration")&nbsp;[<span title="noctx repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/sonatard/noctx)|Finds sending http request without context.Context.|performance, bugs||v1.28.0|
|<span id="list-item-nolintlint" title=""></span>[nolintlint&nbsp;<FaCog size={'0.8rem'} />](#nolintlint "nolintlint configuration")&nbsp;[<span title="nolintlint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/golangci/golangci-lint/tree/HEAD/pkg/golinters/nolintlint/internal)|Reports ill-formed or insufficient nolint directives.|style|<span title="Auto fix supported">✔</span>|v1.26.0|
|<span id="list-item-nonamedreturns" title=""></span>[nonamedreturns&nbsp;<FaCog size={'0.8rem'} />](#nonamedreturns "nonamedreturns configuration")&nbsp;[<span title="nonamedreturns repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/firefart/nonamedreturns)|Reports all named returns.|style||v1.46.0|
|<span id="list-item-nosprintfhostport" title=""></span><span id="nosprintfhostport" title=""></span>[nosprintfhostport](#nosprintfhostport "nosprintfhostport has no configuration")&nbsp;[<span title="nosprintfhostport repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/stbenjam/no-sprintf-host-port)|Checks for misuse of Sprintf to construct a host with port in a URL.|style||v1.46.0|
|<span id="list-item-paralleltest" title=""></span>[paralleltest&nbsp;<FaCog size={'0.8rem'} />](#paralleltest "paralleltest configuration")&nbsp;[<span title="paralleltest repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/kunwardeep/paralleltest)|Detects missing usage of t.Parallel() method in your Go test.|style, test||v1.33.0|
|<span id="list-item-perfsprint" title=""></span>[perfsprint&nbsp;<FaCog size={'0.8rem'} />](#perfsprint "perfsprint configuration")&nbsp;[<span title="perfsprint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/catenacyber/perfsprint)|Checks that fmt.Sprintf can be replaced with a faster alternative.|performance|<span title="Auto fix supported">✔</span>|v1.55.0|
|<span id="list-item-prealloc" title=""></span>[prealloc&nbsp;<FaCog size={'0.8rem'} />](#prealloc "prealloc configuration")&nbsp;[<span title="prealloc repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/alexkohler/prealloc)|Finds slice declarations that could potentially be pre-allocated.|performance||v1.19.0|
|<span id="list-item-predeclared" title=""></span>[predeclared&nbsp;<FaCog size={'0.8rem'} />](#predeclared "predeclared configuration")&nbsp;[<span title="predeclared repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/nishanths/predeclared)|Find code that shadows one of Go's predeclared identifiers.|style||v1.35.0|
|<span id="list-item-promlinter" title=""></span>[promlinter&nbsp;<FaCog size={'0.8rem'} />](#promlinter "promlinter configuration")&nbsp;[<span title="promlinter repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/yeya24/promlinter)|Check Prometheus metrics naming via promlint.|style||v1.40.0|
|<span id="list-item-protogetter" title=""></span>[protogetter&nbsp;<FaCog size={'0.8rem'} />](#protogetter "protogetter configuration")&nbsp;[<span title="protogetter repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ghostiam/protogetter)|Reports direct reads from proto message fields when getters should be used.|bugs|<span title="Auto fix supported">✔</span>|v1.55.0|
|<span id="list-item-reassign" title=""></span>[reassign&nbsp;<FaCog size={'0.8rem'} />](#reassign "reassign configuration")&nbsp;[<span title="reassign repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/curioswitch/go-reassign)|Checks that package variables are not reassigned.|bugs||v1.49.0|
|<span id="list-item-recvcheck" title=""></span>[recvcheck&nbsp;<FaCog size={'0.8rem'} />](#recvcheck "recvcheck configuration")&nbsp;[<span title="recvcheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/raeperd/recvcheck)|Checks for receiver type consistency.|bugs||v1.62.0|
|<span id="list-item-revive" title=""></span>[revive&nbsp;<FaCog size={'0.8rem'} />](#revive "revive configuration")&nbsp;[<span title="revive repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/mgechev/revive)|Fast, configurable, extensible, flexible, and beautiful linter for Go. Drop-in replacement of golint.|style, metalinter|<span title="Auto fix supported">✔</span>|v1.37.0|
|<span id="list-item-rowserrcheck" title=""></span>[rowserrcheck&nbsp;<FaCog size={'0.8rem'} />](#rowserrcheck "rowserrcheck configuration")&nbsp;[<span title="rowserrcheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/jingyugao/rowserrcheck)|Checks whether Rows.Err of rows is checked successfully.|bugs, sql||v1.23.0|
|<span id="list-item-sloglint" title=""></span>[sloglint&nbsp;<FaCog size={'0.8rem'} />](#sloglint "sloglint configuration")&nbsp;[<span title="sloglint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/go-simpler/sloglint)|Ensure consistent code style when using log/slog.|style||v1.55.0|
|<span id="list-item-spancheck" title=""></span>[spancheck&nbsp;<FaCog size={'0.8rem'} />](#spancheck "spancheck configuration")&nbsp;[<span title="spancheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/jjti/go-spancheck)|Checks for mistakes with OpenTelemetry/Census spans.|bugs||v1.56.0|
|<span id="list-item-sqlclosecheck" title=""></span><span id="sqlclosecheck" title=""></span>[sqlclosecheck](#sqlclosecheck "sqlclosecheck has no configuration")&nbsp;[<span title="sqlclosecheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ryanrolds/sqlclosecheck)|Checks that sql.Rows, sql.Stmt, sqlx.NamedStmt, pgx.Query are closed.|bugs, sql||v1.28.0|
|<span id="list-item-stylecheck" title=""></span>[stylecheck&nbsp;<FaCog size={'0.8rem'} />](#stylecheck "stylecheck configuration")&nbsp;[<span title="stylecheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/dominikh/go-tools/tree/HEAD/stylecheck)|Stylecheck is a replacement for golint.|style|<span title="Auto fix supported">✔</span>|v1.20.0|
|<span id="list-item-tagalign" title=""></span>[tagalign&nbsp;<FaCog size={'0.8rem'} />](#tagalign "tagalign configuration")&nbsp;[<span title="tagalign repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/4meepo/tagalign)|Check that struct tags are well aligned.|style|<span title="Auto fix supported">✔</span>|v1.53.0|
|<span id="list-item-tagliatelle" title=""></span>[tagliatelle&nbsp;<FaCog size={'0.8rem'} />](#tagliatelle "tagliatelle configuration")&nbsp;[<span title="tagliatelle repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ldez/tagliatelle)|Checks the struct tags.|style||v1.40.0|
|<span id="list-item-testableexamples" title=""></span><span id="testableexamples" title=""></span>[testableexamples](#testableexamples "testableexamples has no configuration")&nbsp;[<span title="testableexamples repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/maratori/testableexamples)|Linter checks if examples are testable (have an expected output).|test||v1.50.0|
|<span id="list-item-testifylint" title=""></span>[testifylint&nbsp;<FaCog size={'0.8rem'} />](#testifylint "testifylint configuration")&nbsp;[<span title="testifylint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/Antonboom/testifylint)|Checks usage of github.com/stretchr/testify.|test, bugs|<span title="Auto fix supported">✔</span>|v1.55.0|
|<span id="list-item-testpackage" title=""></span>[testpackage&nbsp;<FaCog size={'0.8rem'} />](#testpackage "testpackage configuration")&nbsp;[<span title="testpackage repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/maratori/testpackage)|Linter that makes you use a separate _test package.|style, test||v1.25.0|
|<span id="list-item-thelper" title=""></span>[thelper&nbsp;<FaCog size={'0.8rem'} />](#thelper "thelper configuration")&nbsp;[<span title="thelper repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/kulti/thelper)|Thelper detects tests helpers which is not start with t.Helper() method.|test||v1.34.0|
|<span id="list-item-tparallel" title=""></span><span id="tparallel" title=""></span>[tparallel](#tparallel "tparallel has no configuration")&nbsp;[<span title="tparallel repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/moricho/tparallel)|Tparallel detects inappropriate usage of t.Parallel() method in your Go test codes.|style, test||v1.32.0|
|<span id="list-item-unconvert" title=""></span>[unconvert&nbsp;<FaCog size={'0.8rem'} />](#unconvert "unconvert configuration")&nbsp;[<span title="unconvert repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/mdempsky/unconvert)|Remove unnecessary type conversions.|style||v1.0.0|
|<span id="list-item-unparam" title=""></span>[unparam&nbsp;<FaCog size={'0.8rem'} />](#unparam "unparam configuration")&nbsp;[<span title="unparam repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/mvdan/unparam)|Reports unused function parameters.|unused||v1.9.0|
|<span id="list-item-usestdlibvars" title=""></span>[usestdlibvars&nbsp;<FaCog size={'0.8rem'} />](#usestdlibvars "usestdlibvars configuration")&nbsp;[<span title="usestdlibvars repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/sashamelentyev/usestdlibvars)|A linter that detect the possibility to use variables/constants from the Go standard library.|style|<span title="Auto fix supported">✔</span>|v1.48.0|
|<span id="list-item-usetesting" title=""></span>[usetesting&nbsp;<FaCog size={'0.8rem'} />](#usetesting "usetesting configuration")&nbsp;[<span title="usetesting repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ldez/usetesting)|Reports uses of functions with replacement inside the testing package.|test|<span title="Auto fix supported">✔</span>|v1.63.0|
|<span id="list-item-varnamelen" title=""></span>[varnamelen&nbsp;<FaCog size={'0.8rem'} />](#varnamelen "varnamelen configuration")&nbsp;[<span title="varnamelen repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/blizzy78/varnamelen)|Checks that the length of a variable's name matches its scope.|style||v1.43.0|
|<span id="list-item-wastedassign" title=""></span><span id="wastedassign" title=""></span>[wastedassign](#wastedassign "wastedassign has no configuration")&nbsp;[<span title="wastedassign repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/sanposhiho/wastedassign)|Finds wasted assignment statements.|style||v1.38.0|
|<span id="list-item-whitespace" title=""></span>[whitespace&nbsp;<FaCog size={'0.8rem'} />](#whitespace "whitespace configuration")&nbsp;[<span title="whitespace repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ultraware/whitespace)|Whitespace is a linter that checks for unnecessary newlines at the start and end of functions, if, for, etc.|style|<span title="Auto fix supported">✔</span>|v1.19.0|
|<span id="list-item-wrapcheck" title=""></span>[wrapcheck&nbsp;<FaCog size={'0.8rem'} />](#wrapcheck "wrapcheck configuration")&nbsp;[<span title="wrapcheck repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/tomarrell/wrapcheck)|Checks that errors returned from external packages are wrapped.|style, error||v1.32.0|
|<span id="list-item-wsl" title=""></span>[wsl&nbsp;<FaCog size={'0.8rem'} />](#wsl "wsl configuration")&nbsp;[<span title="wsl repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/bombsimon/wsl)|Add or remove empty lines.|style|<span title="Auto fix supported">✔</span>|v1.20.0|
|<span id="list-item-zerologlint" title=""></span><span id="zerologlint" title=""></span>[zerologlint](#zerologlint "zerologlint has no configuration")&nbsp;[<span title="zerologlint repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/ykadowak/zerologlint)|Detects the wrong usage of `zerolog` that a user forgets to dispatch with `Send` or `Msg`.|bugs||v1.53.0|
|<span id="list-item-tenv" title=""></span><span id="tenv" title=""></span>[tenv](#tenv "tenv has no configuration")&nbsp;[<span title="tenv repository"><FaGithub size={'0.8rem'} /></span>](https://github.com/sivchari/tenv)&nbsp;<span title="deprecated since v1.64.0">⚠</span>|Duplicate feature in another linter. Replaced by usetesting.|test||v1.43.0|
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-asasalint)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-bidichk)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-copyloopvar)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-cyclop)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-decorder)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-depguard)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-dogsled)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-dupl)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-dupword)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-errcheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-errchkjson)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-errorlint)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-exhaustive)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-exhaustruct)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-fatcontext)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-forbidigo)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-funlen)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gci)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-ginkgolinter)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gochecksumtype)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gocognit)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-goconst)


### gocritic

Provides diagnostics that check for bugs, performance and style issues.<br/>Extensible without recompilation through dynamic rules.<br/>Dynamic rules are written declaratively with AST patterns, filters, report message and optional suggestion.
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gocritic)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gocyclo)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-godot)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-godox)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gofmt)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gofumpt)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-goheader)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-goimports)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gomoddirectives)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gomodguard)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gosimple)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gosec)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-gosmopolitan)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-govet)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-grouper)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-iface)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-importas)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-inamedparam)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-interfacebloat)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-ireturn)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-lll)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-loggercheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-maintidx)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-makezero)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-misspell)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-mnd)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-musttag)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-nakedret)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-nestif)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-nilnil)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-nlreturn)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-nolintlint)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-nonamedreturns)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-paralleltest)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-perfsprint)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-prealloc)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-predeclared)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-promlinter)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-protogetter)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-reassign)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-recvcheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-revive)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-rowserrcheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-sloglint)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-spancheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-staticcheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-stylecheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-tagalign)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-tagliatelle)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-tenv)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-testifylint)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-testpackage)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-thelper)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-usestdlibvars)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-usetesting)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-unconvert)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-unparam)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-unused)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-varnamelen)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-whitespace)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-wrapcheck)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-wsl)
...
[<span title="Back to the top"><FaArrowUp /></span>](#list-item-custom)
